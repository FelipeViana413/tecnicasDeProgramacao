...
*Este projeto foi construído com o apoio de assistência de IA (Claude, da Anthropic) para depuração de erros e explicação de conceitos ao longo do desenvolvimento.*
